...
OBJS = src/module.o src/pgvector_compat.o src/hnsw.o src/hnswbuild.o src/hnswinsert.o src/hnswscan.o src/hnswutils.o src/hnswvacuum.o src/linear.o src/linear_scan.o src/hnswtopk.o src/linear_parallel.o
